...
var CartLine = (function () {
    ...
    Object.defineProperty(CartLine.prototype, "lineTotal", {
        get: function () { return this.quantity * this.product.price; },
        enumerable: true,
        configurable: true
    });
    CartLine = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [product_model_1.Product, Number])
    ], CartLine);
    return CartLine;
}());
...
var Cart = (function () {
    ...
    Cart.prototype.removeLine = function (id) {
        // console.log(`From Cart RemoveLine the Id is: ${id}`)
