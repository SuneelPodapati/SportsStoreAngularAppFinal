...
var product_repository_1 = require("../models/product.repository");
...
var StoreComponent = (function () {
    ...
    Object.defineProperty(StoreComponent.prototype, "categories", {
        get: function () { return this.repository.getCatgories(); },
        enumerable: true,
        configurable: true
    });
    StoreComponent.prototype.changeCategory = function (newCategory) { this.selectedCategory = newCategory; };
    StoreComponent.prototype.changePage = function (newPage) { this.selectedPage = newPage; };
    ...
    Object.defineProperty(StoreComponent.prototype, "pageNumbers", {
        ...
        get: function () {
            return Array(Math.ceil(this.repository.getProducts().length / this.productsPerPage)).fill(0).map(function (x, i) { return i + 1; });
        },
        enumerable: true,
        configurable: true
    });
